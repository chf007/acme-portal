defmodule AcmePortalWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AcmePortalWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AcmePortalWeb.Gettext, "errors", msg, opts)
    end
  end
